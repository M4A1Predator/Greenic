            ...
            <div class="row margin-bottom-20">
                <div class="col-sm-6">
                    <select class="form-control district">
                        <option>แสดงทุกฟาร์ม</option>
                        <option value="F0001">ฟาร์มริมเขา นครนายก</option>
                        <option value="F0005">ฟาร์มบ้านทุ่งกุลา สุพรรณบุรี</option>
                        <option value="F0009">ฟาร์มริมธาร กลางขุเขา นครนายก</option>
                    </select>                                                    
                </div>
                <div class="col-sm-6">
                    <select class="form-control district">
                        <option>แสดงทุกประเภท</option>
                        <option value="F0001">ผัก</option>
                        <option value="F0005">ผลไม้</option>
                        <option value="F0009">สัตว์</option>
                    </select>                                                    
                </div>
            </div>
			<div class="row">
