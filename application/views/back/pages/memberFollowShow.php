                    ...
                    <div class="action dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="dropdownMenu1">
							<a class="dropdown-item" href="<?=base_url()?>mats/backAssets/#" data-toggle="modal" data-target="#confirm-modal"><i class="fa fa-close icon"></i>ลบทั้งหมดที่เลือก</a>
                                    ...
                                    <p class="title-description"> ของคุณ <strong>ชายไทย หัวใจสยาม</strong> </p>
                                </div>
                            </div>
                        </div>
                        <div class="items-search">
                            <form class="form-inline">
                              <select class="form-control district">
                                                       <option>เลือกประเภทการติดตาม</option>
                                                        <option value="vegetable">ติดตามเกษตรกร</option>
                                                        <option value="fruit">ติดตามฟาร์ม</option>
                                                        <option value="animal">ติดสินค้า</option>
                                                    </select>
                            </form>
                        </div>
                    </div>
                    <div class="card items">
						...
						<span></span>
                                    ...
                                    <div class="item-col item-col-header item-col-title">
                                        <div> <span>ชื่อรายการ</span> </div>
                                    </div>
                                    <div class="item-col item-col-header item-col-sales">
                                        <div> <span>รายละเอียด</span> </div>
                                    </div>
                                    <div class="item-col item-col-header item-col-date">
                                        <div> <span>วันที่กดติดตาม</span> </div>
                                    </div>
                            ...
                            <li class="item">
                                <div class="item-row">
                                    ...
                                    <div class="item-col fixed pull-left item-col-title">
                                        <div class="item-heading">ชื่อรายการ</div>
                                        <div>
                                            <a>
                                                <h4 class="item-title">ติดตามเกษตรกร</h4> </a>
                                        </div>
                                    </div>
                                    <div class="item-col item-col-sales">
                                        <div class="item-heading">รายละเอียด</div>
                                        <div> วีรชัย สมัยนิยม </div>
                                    </div>
                            ...
                            <li class="item">
                                <div class="item-row">
                                    ...
                                    <div class="item-col fixed pull-left item-col-title">
                                        ...
                                        <div>
                                            <a>
                                                <h4 class="item-title">ติดตามฟาร์ม</h4> </a>
                                        </div>
                                    </div>
                                    <div class="item-col item-col-sales">
                                        <div class="item-heading">รายละเอียด</div>
                                        <div>ไร่ผักลุงจอน@นครนายก</div>
                                    </div>
                                    <div class="item-col item-col-date">
                                        <div class="item-heading">วันที่เพิ่ม</div>
                                        <div class="no-overflow"> 21 กันยายน 2559 10:45น. </div>
                            ...
                            <li class="item">
                                <div class="item-row">
                                    ...
                                    <div class="item-col fixed pull-left item-col-title">
                                        ...
                                        <div>
                                            <a>
                                                <h4 class="item-title">ติดตามสินค้า</h4> </a>
                                        </div>
                                    </div>
                                    <div class="item-col item-col-sales">
                                        <div class="item-heading">รายละเอียด</div>
                                        <div> ปลานิลในบ่อพลาสติก อาหารธรรมชาติ </div>
                                    </div>
                                    <div class="item-col item-col-date">
                                        <div class="item-heading">วันที่เพิ่ม</div>
                                        <div class="no-overflow"> 21 กันยายน 2559 10:45น. </div>
                            ...
                            <li class="item">
                                <div class="item-row">
                                    ...
                                    <div class="item-col item-col-sales">
                                        <div class="item-heading">รายละเอียด</div>
                                        <div> ผักบุ้งจีน ปุ๋ยอินทรีย์ 100% </div>
                                    </div>
                                    <div class="item-col item-col-date">
                                        <div class="item-heading">วันที่เพิ่ม</div>
                                        <div class="no-overflow"> 21 กันยายน 2559 10:45น. </div>
