...
--
-- Host: localhost
-- Generation Time: Oct 16, 2016 at 09:13 AM
...
CREATE TABLE IF NOT EXISTS `greenic_activity_type` (
`activity_type_id` int(11) NOT NULL,
  `activity_type_name` varchar(100) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `greenic_activity_type`
--

INSERT INTO `greenic_activity_type` (`activity_type_id`, `activity_type_name`) VALUES
(1, 'add_project'),
(2, 'update_timeline'),
(3, 'available'),
(4, 'unavailable'),
...
CREATE TABLE IF NOT EXISTS `greenic_admin` (
...
--
-- Dumping data for table `greenic_admin`
--

INSERT INTO `greenic_admin` (`admin_id`, `admin_username`, `admin_level`, `admin_member_id`) VALUES
(1, 'admin_01', 1, 15);
...
CREATE TABLE IF NOT EXISTS `greenic_article` (
...
--
-- Dumping data for table `greenic_article`
--

INSERT INTO `greenic_article` (`article_id`, `article_headline`, `article_cover_image`, `article_content`, `article_view`, `article_time`, `article_member_id`, `article_status_id`) VALUES
(1, 'บทความแรก', NULL, '<p>asd</p>\r\n', 0, '2016-09-17 08:32:28', 15, 3),
(2, 'การเรียนรู้ด้วยตนเอง', NULL, '<p><strong>wtf</strong></p>\r\n\r\n<p>get rekt เทส ทดสอบ ออพเปอร์</p>\r\n', 0, '2016-09-17 08:32:28', 15, 3),
(4, 'บริหารงานที่น้อย', 'files/articles/cover_imgs/art_4dd311b97b347a229ccd419645f38ac0187259c5.jpg', '<p>nV</p>\r\n', 0, '2016-09-17 09:09:24', 15, 3),
(5, 'เทสบทความ', 'files/articles/cover_imgs/art_bac516ddc7a76808084d312d1451240e0370c39d.jpg', '<p>ทดสอบบทฟาร์ม</p>\r\n\r\n<hr>\r\n<p><img alt="" src="http://localhost/greenic/files/projects/covers/prm_14_84b6ab1d04ed7a20326aa6e6a603beca70aa17fa.jpg"></p>\r\n\r\n<p>สักหน่อย</p>\r\n', 0, '2016-09-17 14:48:22', 15, 3);
...
CREATE TABLE IF NOT EXISTS `greenic_breed` (
...
--
-- Dumping data for table `greenic_breed`
--

INSERT INTO `greenic_breed` (`breed_id`, `breed_name`, `breed_category_id`, `breed_creator_id`) VALUES
(1, 'จีน', 13, 14),
(2, 'ไทย', 13, 14),
(3, 'จีน', 14, 14),
(4, 'ดำ', 15, 14),
...
CREATE TABLE IF NOT EXISTS `greenic_category` (
...
--
-- Dumping data for table `greenic_category`
--

INSERT INTO `greenic_category` (`category_id`, `category_name`, `category_description`, `category_datetime`, `category_project_type_id`, `category_creator_id`) VALUES
(13, 'หัวหอม', '', '2016-10-09 13:10:18', 1, NULL),
(14, 'ผักบุ้ง', '', '2016-10-09 13:10:18', 1, 14),
(15, 'องุ่น', '', '2016-10-09 13:10:18', 2, 14),
(16, 'แอปเปิ้ล', '', '2016-10-09 13:10:18', 2, 14),
(17, 'เมล่อน', '', '2016-10-09 13:10:18', 2, 14),
(18, 'มะนาว', '', '2016-10-11 00:17:17', 1, 28),
(19, 'ผักสลัด', '', '2016-10-11 01:02:03', 1, 28),
(20, 'มะละกอ', '', '2016-10-11 02:16:17', 2, 28),
(21, 'ชะอม', '', '2016-10-11 02:26:06', 1, 29),
(22, 'ผักกาด', '', '2016-10-11 03:15:15', 1, 26);

-- --------------------------------------------------------

--
-- Stand-in structure for view `greenic_category_view`
--
CREATE TABLE IF NOT EXISTS `greenic_category_view` (
`category_id` int(11)
,`category_name` varchar(256)
,`category_description` varchar(256)
,`category_datetime` datetime
,`category_project_type_id` int(11)
,`category_creator_id` int(11)
...
CREATE TABLE IF NOT EXISTS `greenic_chat` (
...
CREATE TABLE IF NOT EXISTS `greenic_district` (
...
--
-- Dumping data for table `greenic_district`
--

INSERT INTO `greenic_district` (`district_id`, `district_code`, `district_name`, `district_geo_id`, `district_province_id`) VALUES
...
(108, '1681', 'อ.บ้านเช่าจ.ลพบุรี', 2, 7),
...
(170, '2281', 'กิ่งอ.กำพุธจ.จันทบุรี', 5, 13),
...
(345, '3481', 'อ.สุวรรณวารีจ.อุบลราชธานี', 3, 23),
...
(548, '4781', 'อ.บ้านหันจ.สกลนคร', 3, 35),
...
(682, '5881', 'อ.ม่วยต่อจ.แม่ฮ่องสอน', 1, 46),
...
(729, '6381', 'กิ่งอ.ท่าปุยจ.ตาก', 4, 50),
...
(796, '7181', 'บ้านทวนจ.กาญจนบุรี', 4, 56),
...
(904, '8481', 'อ.บ้านดอนจ.สุราษฎร์ธานี', 6, 67),
...
(998, '9681', 'อ.บางนราจ.นราธิวาส', 6, 76),
...
CREATE TABLE IF NOT EXISTS `greenic_farm` (
...
--
-- Dumping data for table `greenic_farm`
--

INSERT INTO `greenic_farm` (`farm_id`, `farm_name`, `farm_province`, `farm_district`, `farm_sub_district`, `farm_address`, `farm_member_id`, `farm_status_id`) VALUES
(3, 'FaZeClan', 'กรุงเทพมหานคร   ', 'เขตบางรัก   ', 'บางรัก', '11/111 หมู่ 2 ซอย 9 ถนน บางรัก', 14, 5),
(4, 'test', 'จันทบุรี   ', 'ขลุง   ', 'sd', 'aa', 14, 5),
(5, 'MLG', 'กรุงเทพมหานคร   ', 'เขตคลองสาน   ', 'มั่ว', '111/11', 25, 1),
(6, 'C9', 'ตาก   ', 'ท่าสองยาง   ', '*-*-*-*-*', 'หมู่ 1 ตรงกลาง', 14, 1),
(7, 'MyLIFE', 'กรุงเทพมหานคร', 'เขตบางคอแหลม', 'บางคอแหลม', '555/55', 14, 1),
(8, 'FNO', 'เชียงใหม่', 'เชียงดาว', 'แม่นะ', '555+', 14, 1),
(9, 'สวนมะนาวแป้น', 'ชลบุรี', 'บางละมุง', 'บางละมุง', '45/25', 28, 1),
(10, 'Fresh Farm', 'ชัยนาท', 'เนินขาม', 'เนินขาม', '102/3', 28, 1),
(11, 'Prapakorn', 'อุบลราชธานี', 'ดอนมดแดง', 'ดอนมดแดง', '124', 27, 1),
(12, 'พาพ๊ะย๊าา', 'กาญจนบุรี', 'ท่ามะกา', 'ดอนขมิ้น', '99/99', 29, 1),
(13, 'ฟาร์มดี', 'ราชบุรี', 'บ้านโป่ง', 'ปากแรต', '125/1', 26, 1);

-- --------------------------------------------------------

--
-- Stand-in structure for view `greenic_farm_view`
--
CREATE TABLE IF NOT EXISTS `greenic_farm_view` (
`farm_id` int(11)
,`farm_name` varchar(300)
,`farm_province` varchar(256)
,`farm_district` varchar(256)
,`farm_sub_district` varchar(200)
,`farm_address` varchar(600)
,`farm_member_id` int(11)
,`farm_status_id` int(11)
,`member_id` int(11)
,`member_email` varchar(100)
,`member_firstname` varchar(200)
,`member_lastname` varchar(200)
,`member_password` varchar(512)
,`member_img_path` varchar(512)
,`member_address` varchar(400)
,`member_province` varchar(300)
,`member_district` varchar(300)
,`member_sub_district` varchar(300)
,`member_token` varchar(512)
,`member_regis_time` timestamp
,`member_verify_time` timestamp
,`member_type_id` int(11)
,`member_status_id` int(11)
,`member_status_name` varchar(100)
,`member_type_name` varchar(45)
,`farm_status_name` varchar(100)
);
-- --------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `greenic_follow` (
...
--
-- Dumping data for table `greenic_follow`
--

INSERT INTO `greenic_follow` (`follow_id`, `follow_time`, `follow_member_id`, `follow_project_id`, `follow_farm_id`, `follow_farmer_id`) VALUES
(1, '2016-09-06 13:18:08', 16, 122, NULL, NULL),
(2, '2016-09-08 08:08:26', 16, 121, NULL, NULL),
(3, '2016-09-08 08:08:47', 16, 83, NULL, NULL),
(4, '2016-09-08 16:38:19', 15, 109, NULL, NULL),
(5, '2016-09-18 09:14:37', 25, 125, NULL, NULL),
(7, '2016-10-09 05:35:22', 25, 127, NULL, NULL),
(8, '2016-10-10 17:31:17', 26, 120, NULL, NULL),
(9, '2016-10-11 07:11:18', 26, 129, NULL, NULL),
(10, '2016-10-11 07:12:05', 26, 138, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `greenic_member` (
...
--
-- Dumping data for table `greenic_member`
--

INSERT INTO `greenic_member` (`member_id`, `member_email`, `member_firstname`, `member_lastname`, `member_password`, `member_img_path`, `member_address`, `member_province`, `member_district`, `member_sub_district`, `member_token`, `member_regis_time`, `member_verify_time`, `member_facebook_id`, `member_type_id`, `member_status_id`) VALUES
(14, 'm1@greenic.co', 'เดนนิส', 'ฟนาติก', '$2y$12$uz.ta3CxOtL9A4.K0P1uGOmDn6yigK8t6ZqTbIpUG7ZPOXDLQnsH2', 'files/members/profile_imgs/mm_62122f52a0f7a4113ea324bf45fe0e348c78f90a.png', '1/112', 'สมุทรปราการ', 'บางพลี', 'บางแก้ว', 'b052615c80b78a91687e72c2316ed35319c5b3652b93a4c0ab8382a4593dce41', '2016-09-05 16:15:32', NULL, NULL, 2, 1),
(15, 'a1@gnc.com', 'แอดมิน', NULL, '$2y$12$wmf4i9WUuIaxIwt8sg92P.sPIzFu2bRU7m5N4Hmhoo14qVRV1s1WO', NULL, '', NULL, NULL, NULL, NULL, '2016-09-05 21:13:14', NULL, NULL, 3, 1),
(16, 'tssniper3@gmail.com', 'เก็ทไรท์', 'นิป', '$2y$12$UgkOE9js09HVRB87FzLMWOSEw5zABOYn7McTQgZI0H3JG6ob8x28i', NULL, '', '', '', '', NULL, '2016-09-06 13:14:45', '2016-09-06 13:15:07', NULL, 1, 1),
(24, 'sss@live.com', 'Mem', 'ber', 'fb', NULL, NULL, NULL, NULL, NULL, NULL, '2016-09-10 12:27:03', '2016-09-10 12:27:03', '200634', 2, 1),
(25, 'xian001@live.com', 'Thanachai', 'Swang-arom', '$2y$12$gltWlAOtzxoNCUDfy2X3euUJdCfjWRwVdNCTw0nhqjlIXxog.bKWe', NULL, '1', '', '', '', NULL, '2016-09-10 13:08:06', '2016-09-10 13:08:06', '10206864881200634', 1, 1),
(26, 'm2@greenic.co', 'นีโอ', 'จางมิน', '$2y$12$QxKHFFQH/n.0Ydj4wR1lD.JpXXNCfYts9XJuMvwn86eIyUpTrCq9m', NULL, '', '', '', '', 'cdd55f5545fc617525a8d98106ee17fffd620d6fdabb2e5b71c8b9c9f4d955d6', '2016-09-18 12:34:43', NULL, NULL, 2, 1),
(27, 'dvergreen@hotmail.com', 'Wasin', 'PJ', '$2y$12$WdChN6mE6D/sgDVj4feeEOLLRFF.3S/jobm/D/bK885RreLwjo4zu', NULL, '124', 'กรุงเทพมหานคร', 'เขตดุสิต', 'ดุสิต', NULL, '2016-10-10 16:56:27', '2016-10-11 03:56:27', '10207091737723122', 2, 1),
(28, 'web_dekvip@hotmail.com', 'ลุงคิว', 'ชาวไร่', '$2y$12$ztP7a0NPTXKYyRLq9QRAbO8D1kb8r4EhQApJKPbDajAEbQJl46w7S', NULL, '', '', '', '', NULL, '2016-10-11 04:16:23', '2016-10-11 15:16:23', '10202545670039713', 2, 1),
(29, 'ice_tl_cute@live.com', 'คุณหญิง', 'ศรีสมร', '$2y$12$sNutmvmzZL4xUpx.rjDAuOSSdf6AQPpzWYmh3wehMVMDkUITIBHwe', NULL, '', '', '', '', NULL, '2016-10-11 06:19:56', '2016-10-11 17:19:56', '1418482541514842', 2, 1),
(30, 'wasan.hi@hotmail.com', 'Wasan', 'Sermpanich', '$2y$12$SKT72vRayaBBb0IwMLurj.WbGuShiwFgFGF6zuhQnwzPJqjSCEjs2', 'files/members/profile_imgs/mm_e7f704232317382a57877fb586d383a448e6af8f.png', '', 'ตาก', '', '', NULL, '2016-10-11 07:43:12', '2016-10-11 18:43:12', '1339391749434134', 1, 1);

-- --------------------------------------------------------

--
-- Stand-in structure for view `greenic_member_public_view`
--
CREATE TABLE IF NOT EXISTS `greenic_member_public_view` (
`member_id` int(11)
,`member_email` varchar(100)
,`member_firstname` varchar(200)
,`member_lastname` varchar(200)
...
CREATE TABLE IF NOT EXISTS `greenic_member_type` (
`member_type_id` int(11) NOT NULL,
  `member_type_name` varchar(45) DEFAULT NULL
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `greenic_member_type`
--

INSERT INTO `greenic_member_type` (`member_type_id`, `member_type_name`) VALUES
(1, 'normal'),
(2, 'farmer'),
(3, 'admin');
...
--
-- Stand-in structure for view `greenic_member_view`
--
CREATE TABLE IF NOT EXISTS `greenic_member_view` (
`member_id` int(11)
,`member_email` varchar(100)
,`member_firstname` varchar(200)
,`member_lastname` varchar(200)
...
CREATE TABLE IF NOT EXISTS `greenic_notification` (
...
--
-- Dumping data for table `greenic_notification`
--

INSERT INTO `greenic_notification` (`notification_id`, `noticfication_message`, `notification_time`, `notification_notice`, `notification_member_id`, `notification_project_id`, `notification_project_post_id`, `notification_activity_type_id`) VALUES
(1, NULL, '2016-09-08 10:45:51', 1, 16, 121, 9, 2),
(2, NULL, '2016-10-10 17:34:05', 1, 26, 120, 15, 2),
(3, NULL, '2016-10-11 07:12:29', 1, 26, 138, 26, 2);
...
CREATE TABLE IF NOT EXISTS `greenic_product_shipment` (
`product_shipment_id` int(11) NOT NULL,
  `product_shipment_project_id` int(11) NOT NULL,
  `product_shipment_shipment_id` int(11) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=74 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `greenic_product_shipment`
--

INSERT INTO `greenic_product_shipment` (`product_shipment_id`, `product_shipment_project_id`, `product_shipment_shipment_id`) VALUES
(1, 121, 5),
(2, 122, 3),
(3, 122, 4),
(4, 122, 5),
...
CREATE TABLE IF NOT EXISTS `greenic_product_status` (
...
--
-- Dumping data for table `greenic_product_status`
--

INSERT INTO `greenic_product_status` (`product_status_id`, `product_status_name`, `product_status_name_th`, `product_status_order`) VALUES
(1, 'waiting', 'สินค้ารอการจำหน่าย', 1),
(2, 'available', 'สินค้าพร้อมจำหน่าย', 2),
(3, 'out of stock', 'สินค้าหยุดจำหน่าย', 3);
...
CREATE TABLE IF NOT EXISTS `greenic_project` (
...
--
-- Dumping data for table `greenic_project`
--

INSERT INTO `greenic_project` (`project_id`, `project_name`, `project_detail`, `project_location`, `project_time`, `project_startdate`, `project_enddate`, `project_selldate`, `project_quantity`, `project_ppu`, `project_lowest_order`, `project_cover_image_path`, `project_view`, `project_category_id`, `project_breed_id`, `project_farm_id`, `project_status_id`, `project_unit_id`, `project_product_status_id`) VALUES
(75, 'r', 'r', '', '2016-09-05 17:35:42', '2016-10-10 00:00:00', '2016-10-10 00:00:00', '2016-10-10 00:00:00', 10, 10, 0, 'asd', 0, 13, NULL, 3, 1, 1, 1),
(82, 'TEST', 'DES', NULL, '2016-09-05 17:39:24', '2016-09-01 00:00:00', NULL, '2016-09-02 00:00:00', 100, 20, 0, NULL, 4, 13, NULL, 3, 1, 1, 1),
(83, 'TEST', 'DES', NULL, '2016-09-05 17:39:35', '2016-09-01 00:00:00', NULL, '2016-09-02 00:00:00', 100, 20, 0, NULL, 3, 13, NULL, 3, 1, 1, 1),
(84, 'TEST', 'DES', NULL, '2016-09-05 17:39:58', '2016-09-01 00:00:00', NULL, '2016-09-02 00:00:00', 100, 20, 0, NULL, 0, 13, NULL, 3, 1, 1, 1),
(85, 'TEST', 'DES', NULL, '2016-09-05 17:40:00', '2016-09-01 00:00:00', NULL, '2016-09-02 00:00:00', 100, 20, 0, NULL, 3, 13, NULL, 3, 1, 1, 1),
(86, 'TEST', 'DES', NULL, '2016-09-05 17:40:24', '2016-09-01 00:00:00', NULL, '2016-09-02 00:00:00', 100, 20, 0, NULL, 2, 13, NULL, 3, 1, 1, 1),
(109, 'zzz', 'xzc', NULL, '2016-09-05 17:52:02', '0000-00-00 00:00:00', NULL, '2016-10-10 00:00:00', 900, 105, 20, 'files/projects/prm_14_65a16d29e196fd8e036876200defedf82ba59b1f.jpg', 12, 15, NULL, 3, 1, 2, 1),
(117, 'TEST', 'DES', NULL, '2016-09-05 18:10:41', '2016-09-01 00:00:00', NULL, '2016-09-02 00:00:00', 100, 20, 0, NULL, 14, 13, 1, 3, 1, 1, 1),
(120, 'TEST DATA', 'TEST DATA IMAGE PK FK JOIN', NULL, '2016-09-05 18:15:33', '2016-09-10 00:00:00', NULL, '2016-12-12 00:00:00', 500, 100, 0, 'files/projects/prm_14_87182cf345c43158140e290a7c2085020a5b3856.jpg', 27, 13, 1, 6, 1, 2, 1),
(121, 'ผักหัวหอม', 'หอมไทยเม็ดเล็ก', NULL, '2016-09-05 19:43:21', '0000-00-00 00:00:00', NULL, '2016-10-10 00:00:00', 999, 260, 0, 'files/projects/covers/prm_14_514e864e1c2fdc989b5a935a472f91e43b2748b0.jpg', 211, 13, 2, 3, 1, 2, 1),
(122, 'องุ่นสีดำ', 'องุ่นสีดำ', NULL, '2016-09-05 19:54:55', '0000-00-00 00:00:00', NULL, '2016-12-10 00:00:00', 1500, 390, 10, 'files/projects/covers/prm_14_5d0f45a7db2250f457e391913e355893490fee4a.jpg', 48, 15, 4, 3, 1, 2, 1),
(123, 'ผักผุ้ง นอกเมือง', 'ผักผุ้ง นอกเมือง', NULL, '2016-09-09 10:54:02', '2016-07-06 00:00:00', NULL, '2016-09-10 00:00:00', 500, 203.5, 10, 'files/projects/covers/prm_14_d0f737ec540190aa8aab21d9b42fa6e66965f6c9.jpg', 13, 14, NULL, 7, 1, 4, 1),
(124, 'FB USER', 'DWSDADWSDAW', NULL, '2016-09-10 12:34:03', '2016-03-03 00:00:00', NULL, '2016-11-10 00:00:00', 20, 15000, 0.5, 'files/projects/covers/prm_24_aa8ec234f2eaffdcccd3f13abe9f94e9f82e9ed0.jpg', 16, 16, NULL, 5, 1, 3, 1),
(125, 'ผักบุ้ง High end', 'HIGH Accuracy food.', NULL, '2016-09-10 13:17:41', '0000-00-00 00:00:00', NULL, '0000-00-00 00:00:00', 1900, 250, 10, 'files/projects/covers/prm_14_84b6ab1d04ed7a20326aa6e6a603beca70aa17fa.jpg', 32, 13, 1, 6, 1, 2, 1),
(126, 'MyMelon', 'เมล่อนของฉันนะ', NULL, '2016-09-15 19:00:37', '2016-05-03 00:00:00', NULL, '2017-05-03 00:00:00', 700, 1500, 150, NULL, 6, 17, NULL, 7, 1, 2, 1),
(127, 'หัวหอมไทยแท้', 'หัวหอมไทยแท้ organic', NULL, '2016-09-17 18:44:05', '2016-05-05 00:00:00', NULL, '2017-03-16 00:00:00', 5000, 5000, 5000, 'files/projects/covers/prm_14_c132bf03e9ea27e33304103cc4d308b80ae931a4.jpg', 9, 13, NULL, 7, 1, 2, 2),
(128, 'มะนาวแป้นรำไพ', 'เป็นพันธุ์ลูกผสมระหว่างมะนาวพันธุ์แป้นทะวายกับพันธุ์ต่างประเทศ สามารถผลิตมะนาวนอกฤดูได้ดี เพราะออกดอกติดผลง่าย อายุการเก็บเกี่ยวสั้น คือ ตั้งแต่ออกดอกจนเก็บเกี่ยวได้ใช้เวลาประมาณ 4เดือนครึ่ง ผลมีขนาดค่อนข้างโต ลักษณะผลกลมเป็นผลมีขนาดสม่ำเสมอ เปลือกผลบาง ปริมาณน้ำในผลมีมาก', NULL, '2016-10-11 04:19:59', '2016-09-10 00:00:00', NULL, '2016-12-10 00:00:00', 1000, 90, 10, 'files/projects/covers/prm_28_a4a7784628cf402e42914f889ee3d30869dcb448.jpg', 3, 18, 6, 9, 1, 2, 1),
(129, 'ผักสลัด', '  ในสลัดผัก 1 จาน สามารถใส่อะไรลงไปได้หลายอย่าง ทั้งผัก ผลไม้ เนื้อสัตว์ ไข่ไก่ ขนมปังกรอบ หรือแม้แต่ธัญพืชชนิดต่าง ๆ ก็สามารถรับประทานคู่กับน้ำสลัดอีกมากมายได้สบาย ๆ แต่ถ้าจะคัดเฉพาะผักล้วน ๆ หลายคนก็อาจจะอยากรู้ว่าคนทั่วไปเขานิยมรับประทานผักชนิดไหนกันบ้าง วันนี้กระปุกดอทคอมก็เลยนำความรู้เรื่องผักสลัดหลากหลายชนิดที่คนนิยมมาให้ได้รู้กัน ส่วนจะมีผักชนิดไหนกันบ้าง มาดูเลยค่ะ', NULL, '2016-10-11 05:14:22', '2016-10-15 00:00:00', NULL, '2016-12-15 00:00:00', 5000, 150, 10, 'files/projects/covers/prm_28_3cbe2e1dfdb15b9bfe9595e92b1d3c0834000549.jpg', 8, 19, NULL, 10, 1, 2, 1),
(138, 'มะละกอพันธุ์ใหญ่', 'มะละกอ เป็นไม้ผลชนิดหนึ่ง สูงประมาณ 5-10 เมตร มีถิ่นกำเนิดในอเมริกากลาง ถูกนำเข้าสู่เอเชียตะวันออกเฉียงใต้ในสมัยกรุงศรีอยุธยา ผลดิบมีสีเขียว เมื่อสุกแล้วเนื้อในจะมีสีเหลืองถึงส้ม นิยมนำมารับประทานทั้งสดและนำไปปรุงอาหาร เช่น ส้มตำ ฯลฯ หรือนำไปแปรรูปเป็นผลิตภัณฑ์อื่น ๆ ก็ได้', NULL, '2016-10-11 06:22:44', '2016-10-10 00:00:00', NULL, '2017-02-10 00:00:00', 2000, 20, 10, 'files/projects/covers/prm_29_b4b5d9d725bcdeb6110cfdf6a1a8102d836e54ff.jpg', 4, 20, NULL, 12, 1, 2, 1),
(139, 'ชะอมป่า', 'ชะอม เป็นพืชจำพวกอาเคเซีย นิยมรับประทานในทุกภาคของไทย เป็นพืชยื่นต้น ใช้ใบแก่และอ่อน เป็นสมุนไพร ของไทย ลำต้นของชะอมมีหนาม ใบมีขนาดเล็กและมีกลิ่นฉุน ใบอ่อนของชะอมหรือส่วนยอดของใบสามารถนำมารับประทานได้ มีชื่อเรียกแตกต่างกันไปแต่ละภาค โดยมากมักปลูกตามรั้วบ้านเนื่องจากมีหนามแล้วยังเป็นผักที่ทานได้ตลอดทั้งปี', NULL, '2016-10-11 06:27:37', '0000-00-00 00:00:00', NULL, '2017-03-25 00:00:00', 200, 40, 5, 'files/projects/covers/prm_29_bdac91b4f00a9ebf345b2d0b00bb21d53c72982c.jpg', 0, 21, NULL, 12, 1, 2, 1),
(140, 'สวนมะนาว', 'มะนาวแป้นพวง  สวนอุบลราชธานี ทรงพุ่มสวย ใบหนา เปรี้ยวจิ๊ด  เบอร์ 4 ใหญ่ ราคา 0.60 บาทต่อลูก ถ้า 600 ลูก จะได้600 กิโลกรัม ', NULL, '2016-10-11 06:28:22', '2016-03-15 00:00:00', NULL, '2016-10-20 00:00:00', 1000, 0.6, 10, 'files/projects/covers/prm_27_b2de011fc5b1713e95eb292f553ac3e786595a4c.jpg', 0, 18, 6, 11, 1, 5, 1),
(141, 'สวนมะนาว', 'มะนาวแป้นพวง  สวนอุบลราชธานี ทรงพุ่มสวย ใบหนา เปรี้ยวจิ๊ด ', NULL, '2016-10-11 06:28:22', '2016-03-15 00:00:00', NULL, '2016-10-20 00:00:00', 1000, 0.6, 10, 'files/projects/covers/prm_27_1d8d81c2c0d869e48fc6a770c394060b5d8f21b8.jpg', 0, 18, 6, 11, 1, 5, 1),
(142, 'ผักสลัด', 'ผักม่วงผสมผักเขียว', NULL, '2016-10-11 07:22:15', '2016-05-12 00:00:00', NULL, '2016-08-25 00:00:00', 10000, 500, 10, 'files/projects/covers/prm_26_c98afe25b3a1cb8dc56f16f3429d6ed773089dcb.jpg', 2, 22, 7, 13, 1, 2, 1);
...
CREATE TABLE IF NOT EXISTS `greenic_project_post` (
`project_post_id` int(11) NOT NULL,
...
--
-- Dumping data for table `greenic_project_post`
--

INSERT INTO `greenic_project_post` (`project_post_id`, `project_post_caption`, `project_post_detail`, `project_post_image`, `project_post_time`, `project_post_project_id`) VALUES
(7, 'Tesdt', 'zxczsdawdxcadzxdawedwasdawd', 'files/projects/posts/ppst_120_3ff71b77ab44a819216e45fd2ac201c90532fb2b.jpg', '2016-09-05 19:35:00', 120),
(8, 'Nothing', 'n0thing but headshot.', 'files/projects/posts/ppst_121_e92fe680586e8db004357b86eece9ce62774b751.jpg', '2016-09-05 19:47:18', 121),
(9, 'Rekt', 'MLG', 'files/projects/posts/ppst_121_6bea19c2cc33de04c21acd7efe5b13996a12661c.PNG', '2016-09-08 10:45:51', 121),
(10, 'เริ่มต้น', 'ผลมายังไง', 'files/projects/posts/ppst_124_71fd0628cb20753d82c934996e17608d6518c45b.jpg', '2016-09-10 12:59:55', 124),
(11, 'ปลูก', '', 'files/projects/posts/ppst_125_631b7b5c84563983ea413bf739300058a9707e75.jpg', '2016-09-15 14:20:22', 125),
(12, 'NIP noob', 'iw', 'files/projects/posts/ppst_126_7f4b3e54ec0224039e7bd24a1b60113d54e2eb00.jpg', '2016-09-15 19:03:28', 126),
(13, 'สักหน่อย', '', 'files/projects/posts/ppst_125_6f4a1ee17d2e4f3297bfafc25ddb11907a9bc1d3.jpg', '2016-09-16 17:22:58', 125),
(14, 'Sound Card Gone', '', 'files/projects/posts/ppst_126_fd7d08022bcfa7d89413d98495ddad3afaeea60a.png', '2016-10-08 08:32:47', 126),
(15, 'Update post', 'updated.', 'files/projects/posts/ppst_120_958fada51929d8e9dfc4330b9ab6a2b38aae1889.jpg', '2016-10-10 17:34:05', 120),
(16, 'เตรียมกิ่งพร้อมปลูกแล้วครับ', 'เตรียมกิ่งพร้อมปลูกแล้วครับ อีกสามเดือนเจอกันครับใครสนใจกดติดตามไว้เลยครับ ช้าหมดอดไม่รู้ด้วย', 'files/projects/posts/ppst_128_104d223e6a6b1755d8411501821ec0a75bd498f9.jpg', '2016-10-11 04:20:53', 128),
(17, 'ต้นเริ่มโตแล้ว โตด้วยปุ๋ยอินทรีย์ล้วนๆ', 'ต้นเริ่มโตแล้ว โตด้วยปุ๋ยอินทรีย์ล้วนๆ ไว้ใจไร่เราได้เลยครับใครอยากได้มะนาวคุณภาพเน้นๆ', 'files/projects/posts/ppst_128_82930a8f997606bad253f7047d5be81853292b79.jpg', '2016-10-11 04:21:54', 128),
(18, 'เริ่มปลูกแล้วครับผักสลัดชุดใหม่', 'เริ่มปลูกแล้วครับผักสลัดชุดใหม่ ใครสนใจอย่าลืมกดติดตามอีกเช่นเคยนะครับ หมดไวมากเลย', 'files/projects/posts/ppst_129_ee1d18b909da342e847819b29a6e11d4106e49b1.jpg', '2016-10-11 05:15:07', 129),
(19, 'เริ่มเห็นภาพความสวยงามแล้วครับ', 'เปิดให้จองกันแล้วนะครับ ใครสนใจทักแชทมาจองกันได้เลยครับ รีบๆเด้ออหมดไวมากขอบอกก', 'files/projects/posts/ppst_129_0a0115262004befcfb5135489084c6fca0ec8c9b.jpg', '2016-10-11 05:15:52', 129),
(20, 'พร้อมขายแล้วครับ', 'วันนี้พร้อมขายแล้วครับ มะละกอลูกโตๆใหญ่ๆ รีบๆออเด้อกันเข้ามานะครับ อย่าลืมกดติดตามกันด้วยเด้ออ', 'files/projects/posts/ppst_138_3e6ef399895b0de172f622040ea1f35aa0ef2e3c.jpg', '2016-10-11 06:24:21', 138),
(21, 'เตรียมกิ่งสำหรับปลูกแล้วเด้ออ', 'เตรียมกิ่งสำหรับปลูกแล้วเด้ออ กดติดตามไว้เลย ชะอมพันธุ์นี้อร่อยมาก', 'files/projects/posts/ppst_139_b5037dbc6552de6d29bdabf516241755af79c266.jpg', '2016-10-11 06:28:23', 139),
(22, 'พร้อมเก็บแล้ว ใครจองก่อนได้ก่อน', 'พร้อมเก็บแล้ว ใครจองก่อนได้ก่อน ตอนนี้ยังพอมีเหลือ ทักแชทเลยครับ', 'files/projects/posts/ppst_139_05c88e4d219f00bf1140637b3cc7740a30a714d6.jpg', '2016-10-11 06:29:04', 139),
(23, 'อัพเดท สวนมะนาว', 'อัพเดท #สวนมะนาว กันหน่อยครับ จะครบปีล่ะ ...ฝีมือสองตายาย ช่วยกันดูแล ทรงพุ่มสวยใช้ได้ ใบหนา คงได้เวลาใส่ปุ๋ย สร้างดอก ออกผลให้เก็บกันล่ะ....ช่วงนี้หน้าฝน หญ้าก็งามเหมือนกัน...', 'files/projects/posts/ppst_140_5f7b617d1ab4af4f4392069f23a1305feafeb7d8.jpg', '2016-10-11 06:32:03', 140),
(24, 'อัพเดตสวน', '', 'files/projects/posts/ppst_140_74be91252f6ca18f8caea93ee26a1064faa87a59.jpg', '2016-10-11 06:33:14', 140),
(25, 'อัพเดต', '', 'files/projects/posts/ppst_140_b9428b24674999162092bc02feb185cc5948e02e.jpg', '2016-10-11 06:33:30', 140),
(26, 'ขายหมดแล้วครับ', 'ขายหมดแล้วครับขายหมดแล้วครับขายหมดแล้วครับขายหมดแล้วครับขายหมดแล้วครับขายหมดแล้วครับขายหมดแล้วครับขายหมดแล้วครับขายหมดแล้วครับขายหมดแล้วครับขายหมดแล้วครับขายหมดแล้วครับขายหมดแล้วครับขายหมดแล้วครับขายหมดแล้วครับขายหมดแล้วครับขายหมดแล้วครับขายหมดแล้วครับขายหมดแล้วครับขายหมดแล้วครับขายหมดแล้วครับ', 'files/projects/posts/ppst_138_442b86e42b6d914c8035158e1d43c323611f4f2e.jpg', '2016-10-11 07:12:29', 138),
(27, 'เริ่มปลูก', 'เริ่มปลูกไม่ทันไรน้ำก็ท่วม', 'files/projects/posts/ppst_142_cc7975a9355f39510309a9c6e5070deee51c5d8b.jpg', '2016-10-11 07:23:34', 142);
...
CREATE TABLE IF NOT EXISTS `greenic_project_type` (
`project_type_id` int(11) NOT NULL,
  `project_type_name` varchar(256) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `greenic_project_type`
--

INSERT INTO `greenic_project_type` (`project_type_id`, `project_type_name`) VALUES
(1, 'vegetable'),
(2, 'fruit'),
(3, 'animal');
...
--
-- Stand-in structure for view `greenic_project_view`
--
CREATE TABLE IF NOT EXISTS `greenic_project_view` (
`project_id` int(11)
...
,`project_selldate` datetime
,`project_quantity` float
,`project_ppu` float
,`project_lowest_order` float
,`project_cover_image_path` varchar(512)
,`project_view` int(11)
,`project_category_id` int(11)
,`project_breed_id` int(11)
,`project_farm_id` int(11)
,`project_status_id` int(11)
,`project_unit_id` int(11)
,`project_product_status_id` int(11)
,`category_id` int(11)
,`category_name` varchar(256)
,`category_description` varchar(256)
,`category_project_type_id` int(11)
...
,`breed_category_id` int(11)
,`breed_creator_id` int(11)
,`farm_id` int(11)
,`farm_name` varchar(300)
,`farm_province` varchar(256)
,`farm_district` varchar(256)
...
,`unit_order` int(11)
,`unit_creator_id` int(11)
,`status_id` int(11)
,`status_name` varchar(100)
,`product_status_id` int(11)
,`product_status_name` varchar(50)
,`product_status_name_th` varchar(150)
,`product_status_order` int(11)
);
-- --------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `greenic_province` (
...
--
-- Dumping data for table `greenic_province`
--

INSERT INTO `greenic_province` (`province_id`, `province_code`, `province_name`, `province_geo_id`) VALUES
...
CREATE TABLE IF NOT EXISTS `greenic_review` (
...
--
-- Dumping data for table `greenic_review`
--

INSERT INTO `greenic_review` (`review_id`, `review_rate`, `review_time`, `review_comment`, `review_buydate`, `review_buyamount`, `review_member_id`, `review_project_id`) VALUES
(3, 3, '2016-09-08 13:46:48', 'EETST', '2016-10-10 00:00:00', 200, 16, 121),
(5, 5, '2016-09-08 16:37:57', 'REkt', '2016-08-10 00:00:00', 325, 15, 121),
(7, 3, '2016-09-08 19:40:29', 'sd', '2016-10-10 00:00:00', 222, 16, 120),
(8, 1, '2016-09-10 12:29:32', 'กากสัส', '2016-09-10 00:00:00', 150, 24, 121),
(9, 2, '2016-09-10 17:23:39', 'Noob ', '2016-09-10 00:00:00', 250, 25, 121),
(10, 4, '2016-09-18 12:22:10', 'ทำดี ๆ', '2016-08-10 00:00:00', 250, 25, 125),
(11, 4, '2016-10-11 07:08:20', 'เยี่ยม', '2016-10-11 00:00:00', 10, 26, 129),
(12, 4, '2016-10-11 07:08:20', 'เยี่ยม', '2016-10-11 00:00:00', 10, 26, 129);
...
CREATE TABLE IF NOT EXISTS `greenic_shipment` (
`shipment_id` int(11) NOT NULL,
  `shipment_name` varchar(200) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `greenic_shipment`
--

INSERT INTO `greenic_shipment` (`shipment_id`, `shipment_name`) VALUES
(1, 'ไปรษณีย์ไทย'),
(2, 'kerry express'),
(3, 'จัดส่งเอง'),
(4, 'มารับเอง'),
...
CREATE TABLE IF NOT EXISTS `greenic_status` (
`status_id` int(11) NOT NULL,
  `status_name` varchar(100) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `greenic_status`
--

INSERT INTO `greenic_status` (`status_id`, `status_name`) VALUES
(1, 'normal'),
(2, 'banned'),
(3, 'publish'),
(4, 'draft'),
...
CREATE TABLE IF NOT EXISTS `greenic_sub_district` (
...
--
-- Dumping data for table `greenic_sub_district`
--

INSERT INTO `greenic_sub_district` (`sub_district_id`, `sub_district_code`, `sub_district_name`, `sub_district_district_id`, `sub_district_province_id`, `sub_district_geo_id`) VALUES
...
CREATE TABLE IF NOT EXISTS `greenic_unit` (
...
--
-- Dumping data for table `greenic_unit`
--

INSERT INTO `greenic_unit` (`unit_id`, `unit_name`, `unit_order`, `unit_creator_id`) VALUES
(1, 'กรัม', 1, NULL),
(2, 'กิโลกรัม', 2, NULL),
(3, 'ตัน', 3, NULL),
(4, 'ต้น', 50, 14),
...
CREATE TABLE IF NOT EXISTS `greenic_vote_review` (
`vote_review_id` int(11) NOT NULL,
...
--
-- Dumping data for table `greenic_vote_review`
--

INSERT INTO `greenic_vote_review` (`vote_review_id`, `vote_review_agree`, `vote_review_member_id`, `vote_review_review_id`) VALUES
(4, 1, 25, 8),
(5, 1, 16, 8),
(6, 1, 16, 9),
(7, 0, 16, 5),
...
--
-- Indexes for table `greenic_activity_type`
--
ALTER TABLE `greenic_activity_type`
 ADD PRIMARY KEY (`activity_type_id`);

--
-- Indexes for table `greenic_admin`
--
ALTER TABLE `greenic_admin`
 ADD PRIMARY KEY (`admin_id`), ADD UNIQUE KEY `admin_username_UNIQUE` (`admin_username`), ADD KEY `fk_greenic_admin_greenic_member1_idx` (`admin_member_id`);

--
-- Indexes for table `greenic_article`
--
ALTER TABLE `greenic_article`
 ADD PRIMARY KEY (`article_id`), ADD KEY `fk_greenic_article_greenic_member1_idx` (`article_member_id`), ADD KEY `fk_greenic_article_greenic_status1_idx` (`article_status_id`);

--
-- Indexes for table `greenic_breed`
--
ALTER TABLE `greenic_breed`
 ADD PRIMARY KEY (`breed_id`), ADD KEY `fk_greenic_breed_greenic_category1_idx` (`breed_category_id`), ADD KEY `fk_greenic_breed_greenic_member1_idx` (`breed_creator_id`);

--
-- Indexes for table `greenic_category`
--
ALTER TABLE `greenic_category`
 ADD PRIMARY KEY (`category_id`), ADD KEY `fk_greenic_category_greenic_project_type1_idx` (`category_project_type_id`), ADD KEY `fk_greenic_category_greenic_member1_idx` (`category_creator_id`);

--
-- Indexes for table `greenic_chat`
--
ALTER TABLE `greenic_chat`
 ADD PRIMARY KEY (`chat_id`), ADD KEY `fk_greenic_chat_greenic_member1_idx` (`chat_sender_id`), ADD KEY `fk_greenic_chat_greenic_member2_idx` (`chat_receiver_id`);

--
-- Indexes for table `greenic_district`
--
ALTER TABLE `greenic_district`
 ADD PRIMARY KEY (`district_id`), ADD KEY `fk_greenic_district_greenic_province1_idx` (`district_province_id`);

--
-- Indexes for table `greenic_farm`
--
ALTER TABLE `greenic_farm`
 ADD PRIMARY KEY (`farm_id`), ADD KEY `fk_greenic_farm_greenic_member1_idx` (`farm_member_id`), ADD KEY `fk_greenic_farm_greenic_status1_idx` (`farm_status_id`);

--
-- Indexes for table `greenic_follow`
--
ALTER TABLE `greenic_follow`
 ADD PRIMARY KEY (`follow_id`), ADD KEY `fk_greenic_follow_greenic_member1_idx` (`follow_member_id`), ADD KEY `fk_greenic_follow_greenic_project1_idx` (`follow_project_id`), ADD KEY `fk_greenic_follow_greenic_farm1_idx` (`follow_farm_id`), ADD KEY `fk_greenic_follow_greenic_member2_idx` (`follow_farmer_id`);

--
-- Indexes for table `greenic_member`
--
ALTER TABLE `greenic_member`
 ADD PRIMARY KEY (`member_id`), ADD UNIQUE KEY `member_email_UNIQUE` (`member_email`), ADD KEY `fk_greenic_member_greenic_member_type2_idx` (`member_type_id`), ADD KEY `fk_greenic_member_greenic_status1_idx` (`member_status_id`);

--
-- Indexes for table `greenic_member_type`
--
ALTER TABLE `greenic_member_type`
 ADD PRIMARY KEY (`member_type_id`);

--
-- Indexes for table `greenic_notification`
--
ALTER TABLE `greenic_notification`
 ADD PRIMARY KEY (`notification_id`), ADD KEY `fk_greenic_notification_greenic_member1_idx` (`notification_member_id`), ADD KEY `fk_greenic_notification_greenic_project1_idx` (`notification_project_id`), ADD KEY `fk_greenic_notification_greenic_activity_type1_idx` (`notification_activity_type_id`), ADD KEY `fk_greenic_notification_greenic_project_post1_idx` (`notification_project_post_id`);

--
-- Indexes for table `greenic_product_shipment`
--
ALTER TABLE `greenic_product_shipment`
 ADD PRIMARY KEY (`product_shipment_id`), ADD KEY `fk_greenic_product_shipment_greenic_project1_idx` (`product_shipment_project_id`), ADD KEY `fk_greenic_product_shipment_greenic_shipment1_idx` (`product_shipment_shipment_id`);

--
-- Indexes for table `greenic_product_status`
--
ALTER TABLE `greenic_product_status`
 ADD PRIMARY KEY (`product_status_id`);

--
-- Indexes for table `greenic_project`
--
ALTER TABLE `greenic_project`
 ADD PRIMARY KEY (`project_id`), ADD KEY `fk_greenic_project_greenic_category1_idx` (`project_category_id`), ADD KEY `fk_greenic_project_greenic_farm1_idx` (`project_farm_id`), ADD KEY `fk_greenic_project_greenic_status1_idx` (`project_status_id`), ADD KEY `fk_greenic_project_greenic_unit1_idx` (`project_unit_id`), ADD KEY `fk_greenic_project_greenic_breed1_idx` (`project_breed_id`), ADD KEY `fk_greenic_project_greenic_product_status1_idx` (`project_product_status_id`);

--
-- Indexes for table `greenic_project_post`
--
ALTER TABLE `greenic_project_post`
 ADD PRIMARY KEY (`project_post_id`), ADD KEY `fk_greenic_project_post_greenic_project1_idx` (`project_post_project_id`);

--
-- Indexes for table `greenic_project_type`
--
ALTER TABLE `greenic_project_type`
 ADD PRIMARY KEY (`project_type_id`);

--
-- Indexes for table `greenic_province`
--
ALTER TABLE `greenic_province`
 ADD PRIMARY KEY (`province_id`);

--
-- Indexes for table `greenic_review`
--
ALTER TABLE `greenic_review`
 ADD PRIMARY KEY (`review_id`), ADD KEY `fk_greenic_review_greenic_member1_idx` (`review_member_id`), ADD KEY `fk_greenic_review_greenic_project1_idx` (`review_project_id`);

--
-- Indexes for table `greenic_shipment`
--
ALTER TABLE `greenic_shipment`
 ADD PRIMARY KEY (`shipment_id`);

--
-- Indexes for table `greenic_status`
--
ALTER TABLE `greenic_status`
 ADD PRIMARY KEY (`status_id`);

--
-- Indexes for table `greenic_sub_district`
--
ALTER TABLE `greenic_sub_district`
 ADD PRIMARY KEY (`sub_district_id`), ADD KEY `fk_greenic_sub_district_greenic_province1_idx` (`sub_district_province_id`), ADD KEY `fk_greenic_sub_district_greenic_district1_idx` (`sub_district_district_id`);

--
-- Indexes for table `greenic_unit`
--
ALTER TABLE `greenic_unit`
 ADD PRIMARY KEY (`unit_id`), ADD KEY `fk_greenic_unit_creator_idx` (`unit_creator_id`);

--
-- Indexes for table `greenic_vote_review`
--
ALTER TABLE `greenic_vote_review`
 ADD PRIMARY KEY (`vote_review_id`), ADD KEY `fk_greenic_vote_review_greenic_member1_idx` (`vote_review_member_id`), ADD KEY `fk_greenic_vote_review_greenic_review1_idx` (`vote_review_review_id`);

--
-- Indexes for table `greenic_webdata`
--
ALTER TABLE `greenic_webdata`
 ADD PRIMARY KEY (`webdata_id`);
...
--
-- AUTO_INCREMENT for table `greenic_activity_type`
--
ALTER TABLE `greenic_activity_type`
MODIFY `activity_type_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `greenic_admin`
--
ALTER TABLE `greenic_admin`
MODIFY `admin_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `greenic_article`
--
ALTER TABLE `greenic_article`
MODIFY `article_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `greenic_breed`
--
ALTER TABLE `greenic_breed`
MODIFY `breed_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `greenic_category`
--
ALTER TABLE `greenic_category`
MODIFY `category_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=23;
--
-- AUTO_INCREMENT for table `greenic_chat`
--
ALTER TABLE `greenic_chat`
MODIFY `chat_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `greenic_district`
--
ALTER TABLE `greenic_district`
MODIFY `district_id` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1007;
--
-- AUTO_INCREMENT for table `greenic_farm`
--
ALTER TABLE `greenic_farm`
MODIFY `farm_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT for table `greenic_follow`
--
ALTER TABLE `greenic_follow`
MODIFY `follow_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `greenic_member`
--
ALTER TABLE `greenic_member`
MODIFY `member_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=31;
--
-- AUTO_INCREMENT for table `greenic_member_type`
--
ALTER TABLE `greenic_member_type`
MODIFY `member_type_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `greenic_notification`
--
ALTER TABLE `greenic_notification`
MODIFY `notification_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `greenic_product_shipment`
--
ALTER TABLE `greenic_product_shipment`
MODIFY `product_shipment_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=74;
--
-- AUTO_INCREMENT for table `greenic_product_status`
--
ALTER TABLE `greenic_product_status`
MODIFY `product_status_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `greenic_project`
--
ALTER TABLE `greenic_project`
MODIFY `project_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=143;
--
-- AUTO_INCREMENT for table `greenic_project_post`
--
ALTER TABLE `greenic_project_post`
MODIFY `project_post_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=28;
--
-- AUTO_INCREMENT for table `greenic_project_type`
--
ALTER TABLE `greenic_project_type`
MODIFY `project_type_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `greenic_province`
--
ALTER TABLE `greenic_province`
MODIFY `province_id` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=78;
--
-- AUTO_INCREMENT for table `greenic_review`
--
ALTER TABLE `greenic_review`
MODIFY `review_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT for table `greenic_shipment`
--
ALTER TABLE `greenic_shipment`
MODIFY `shipment_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `greenic_status`
--
ALTER TABLE `greenic_status`
MODIFY `status_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `greenic_unit`
--
ALTER TABLE `greenic_unit`
MODIFY `unit_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `greenic_vote_review`
--
ALTER TABLE `greenic_vote_review`
MODIFY `vote_review_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT for table `greenic_webdata`
--
ALTER TABLE `greenic_webdata`
MODIFY `webdata_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- Constraints for dumped tables
--

--
-- Constraints for table `greenic_admin`
--
ALTER TABLE `greenic_admin`
ADD CONSTRAINT `fk_greenic_admin_greenic_member1` FOREIGN KEY (`admin_member_id`) REFERENCES `greenic_member` (`member_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `greenic_article`
--
ALTER TABLE `greenic_article`
ADD CONSTRAINT `fk_greenic_article_greenic_member1` FOREIGN KEY (`article_member_id`) REFERENCES `greenic_member` (`member_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_greenic_article_greenic_status1` FOREIGN KEY (`article_status_id`) REFERENCES `greenic_status` (`status_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `greenic_breed`
--
ALTER TABLE `greenic_breed`
ADD CONSTRAINT `fk_greenic_breed_greenic_category1` FOREIGN KEY (`breed_category_id`) REFERENCES `greenic_category` (`category_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_greenic_breed_greenic_member1` FOREIGN KEY (`breed_creator_id`) REFERENCES `greenic_member` (`member_id`) ON DELETE SET NULL ON UPDATE SET NULL;

--
-- Constraints for table `greenic_category`
--
ALTER TABLE `greenic_category`
ADD CONSTRAINT `fk_greenic_category_greenic_member1` FOREIGN KEY (`category_creator_id`) REFERENCES `greenic_member` (`member_id`) ON DELETE SET NULL ON UPDATE SET NULL,
ADD CONSTRAINT `fk_greenic_category_greenic_project_type1` FOREIGN KEY (`category_project_type_id`) REFERENCES `greenic_project_type` (`project_type_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `greenic_chat`
--
ALTER TABLE `greenic_chat`
ADD CONSTRAINT `fk_greenic_chat_greenic_member1` FOREIGN KEY (`chat_sender_id`) REFERENCES `greenic_member` (`member_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_greenic_chat_greenic_member2` FOREIGN KEY (`chat_receiver_id`) REFERENCES `greenic_member` (`member_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `greenic_district`
--
ALTER TABLE `greenic_district`
ADD CONSTRAINT `fk_greenic_district_greenic_province1` FOREIGN KEY (`district_province_id`) REFERENCES `greenic_province` (`province_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `greenic_farm`
--
ALTER TABLE `greenic_farm`
ADD CONSTRAINT `fk_greenic_farm_greenic_member1` FOREIGN KEY (`farm_member_id`) REFERENCES `greenic_member` (`member_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_greenic_farm_greenic_status1` FOREIGN KEY (`farm_status_id`) REFERENCES `greenic_status` (`status_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `greenic_follow`
--
ALTER TABLE `greenic_follow`
ADD CONSTRAINT `fk_greenic_follow_greenic_farm1` FOREIGN KEY (`follow_farm_id`) REFERENCES `greenic_farm` (`farm_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_greenic_follow_greenic_member1` FOREIGN KEY (`follow_member_id`) REFERENCES `greenic_member` (`member_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_greenic_follow_greenic_member2` FOREIGN KEY (`follow_farmer_id`) REFERENCES `greenic_member` (`member_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_greenic_follow_greenic_project1` FOREIGN KEY (`follow_project_id`) REFERENCES `greenic_project` (`project_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `greenic_member`
--
ALTER TABLE `greenic_member`
ADD CONSTRAINT `fk_greenic_member_greenic_member_type2` FOREIGN KEY (`member_type_id`) REFERENCES `greenic_member_type` (`member_type_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_greenic_member_greenic_status1` FOREIGN KEY (`member_status_id`) REFERENCES `greenic_status` (`status_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `greenic_notification`
--
ALTER TABLE `greenic_notification`
ADD CONSTRAINT `fk_greenic_notification_greenic_activity_type1` FOREIGN KEY (`notification_activity_type_id`) REFERENCES `greenic_activity_type` (`activity_type_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_greenic_notification_greenic_member1` FOREIGN KEY (`notification_member_id`) REFERENCES `greenic_member` (`member_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_greenic_notification_greenic_project1` FOREIGN KEY (`notification_project_id`) REFERENCES `greenic_project` (`project_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_greenic_notification_greenic_project_post1` FOREIGN KEY (`notification_project_post_id`) REFERENCES `greenic_project_post` (`project_post_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `greenic_product_shipment`
--
ALTER TABLE `greenic_product_shipment`
ADD CONSTRAINT `fk_greenic_product_shipment_greenic_project1` FOREIGN KEY (`product_shipment_project_id`) REFERENCES `greenic_project` (`project_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_greenic_product_shipment_greenic_shipment1` FOREIGN KEY (`product_shipment_shipment_id`) REFERENCES `greenic_shipment` (`shipment_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `greenic_project`
--
ALTER TABLE `greenic_project`
ADD CONSTRAINT `fk_greenic_project_greenic_breed1` FOREIGN KEY (`project_breed_id`) REFERENCES `greenic_breed` (`breed_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_greenic_project_greenic_category1` FOREIGN KEY (`project_category_id`) REFERENCES `greenic_category` (`category_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_greenic_project_greenic_farm1` FOREIGN KEY (`project_farm_id`) REFERENCES `greenic_farm` (`farm_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_greenic_project_greenic_product_status1` FOREIGN KEY (`project_product_status_id`) REFERENCES `greenic_product_status` (`product_status_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_greenic_project_greenic_status1` FOREIGN KEY (`project_status_id`) REFERENCES `greenic_status` (`status_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_greenic_project_greenic_unit1` FOREIGN KEY (`project_unit_id`) REFERENCES `greenic_unit` (`unit_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `greenic_project_post`
--
ALTER TABLE `greenic_project_post`
ADD CONSTRAINT `fk_greenic_project_post_greenic_project1` FOREIGN KEY (`project_post_project_id`) REFERENCES `greenic_project` (`project_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `greenic_review`
--
ALTER TABLE `greenic_review`
ADD CONSTRAINT `fk_greenic_review_greenic_member1` FOREIGN KEY (`review_member_id`) REFERENCES `greenic_member` (`member_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_greenic_review_greenic_project1` FOREIGN KEY (`review_project_id`) REFERENCES `greenic_project` (`project_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `greenic_sub_district`
--
ALTER TABLE `greenic_sub_district`
ADD CONSTRAINT `fk_greenic_sub_district_greenic_district1` FOREIGN KEY (`sub_district_district_id`) REFERENCES `greenic_district` (`district_id`) ON DELETE CASCADE ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_greenic_sub_district_greenic_province1` FOREIGN KEY (`sub_district_province_id`) REFERENCES `greenic_province` (`province_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `greenic_unit`
--
ALTER TABLE `greenic_unit`
ADD CONSTRAINT `fk_greenic_unit_creator` FOREIGN KEY (`unit_creator_id`) REFERENCES `greenic_member` (`member_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `greenic_vote_review`
--
ALTER TABLE `greenic_vote_review`
ADD CONSTRAINT `fk_greenic_vote_review_greenic_member1` FOREIGN KEY (`vote_review_member_id`) REFERENCES `greenic_member` (`member_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_greenic_vote_review_greenic_review1` FOREIGN KEY (`vote_review_review_id`) REFERENCES `greenic_review` (`review_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
