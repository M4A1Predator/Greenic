<article class="content items-list-page">
    ...
    <div class="card sameheight-item">
        <?php foreach($project_types as $pt){ ?>
            <a href="<?=base_url().'gnc_admin/project_type/'.$pt->project_type_id?>" class="btn btn-secondary  btn-lg btn-block"><?=get_project_type_thai_text($pt->project_type_id)?> (<?=$pt->category_count?>)</a>
        <?php } ?>
