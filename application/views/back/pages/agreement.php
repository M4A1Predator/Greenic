...
<input id="oldData" value="<?=$agreement->webdata_value?>" />
<article class="content item-editor-page">
		...
		แก้ไขหน้า <span class="sparkline bar" data-type="bar"></span>
				...
				ชื่อหน้า:
                                ...
                                <div class="col-sm-10"> <input type="text" class="form-control boxed" value="ข้อตกลงการใช้งาน" disabled> </div>
                            </div>
                            <div class="form-group row"> <label class="col-sm-2 form-control-label text-xs-right">
				เนื้อหา:
			</label>
...
<script src="<?=base_url()?>mats/backJs/webdata/agreement.js"></script>