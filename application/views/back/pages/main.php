                            ...
                            <div class="col col-xs-12 col-sm-12 col-md-12 col-xl-12 stats-col">
                                <div class="card sameheight-item stats" data-exclude="xs">
                                    <div class="card-block">
                                        <div class="title-block">
                                            <h4 class="title">สถิติของ Greenic</h4>
                                            <p class="title-description">ภาพรวม </p>
                                        </div>
            					...
            					<div class="progress">
            						<span class="progress-bar" style="width: 75%;"></span>
                                            ...
                                            <div class="col-xs-12 col-sm-6 stat-col">
                                                <div class="stat-icon"> <i class="fa fa-thumb-tack"></i> </div>
                                                <div class="stat">
                                                    <div class="value"> <?=$farm_count?> </div>
                                                    <div class="name"> ฟาร์ม </div>
                                                </div> <progress class="progress stat-progress" value="100" max="100">
            					<div class="progress">
            						<span class="progress-bar" style="width: 25%;"></span>
                                            ...
                                            <div class="col-xs-12 col-sm-6  stat-col">
                                                ...
                                                <div class="stat">
                                                    <div class="value"> <?=$farmer_count?> </div>
                                                    <div class="name"> เกษตรกร </div>
                                                </div> <progress class="progress stat-progress" value="100" max="100">
            					<div class="progress">
            					...
            					<div class="progress">
            						<span class="progress-bar" style="width: 34%;"></span>
                                            ...
                                            <div class="col-xs-12 col-sm-6  stat-col">
                                                ...
                                                <div class="stat">
                                                    <div class="value"> <?=$conversation_count?> </div>
                                                    <div class="name"> การสนทนา </div>
                                                </div> <progress class="progress stat-progress" value="100" max="100">
            					<div class="progress">
            						<span class="progress-bar" style="width: 49%;"></span>
                                            ...
                                            <div class="col-xs-12 col-sm-6 stat-col">
                                                ...
                                                <div class="stat">
                                                    ...
                                                    <div class="name"> สมาชิกทั่วไป </div>
                                                </div> <progress class="progress stat-progress" value="100" max="100">
            					<div class="progress">
