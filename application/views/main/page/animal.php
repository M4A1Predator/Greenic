        <div class="breadcrumbs">
			<div class="container">
				<h1 class="pull-left">สัตว์อินทรีย์</h1>
				<ul class="pull-right breadcrumb">
					<li><a href="index.php">หน้าแรก</a></li>
					<li class="active">สัตว์อินทรีย์</li>
				</ul>
			</div>
		</div>
        <div class="container content-md">
            <div class="row margin-bottom-40">
                ...
                <div class="col-sm-6 col-md-3">
					<a href="subCategory.php"  class="btn-u btn-brd btn-u-brown btn-u-lg subCate">ปลาดุก (4)</a>
				</div>
                <div class="col-sm-6 col-md-3">
					<a href="subCategory.php"  class="btn-u btn-brd btn-u-brown btn-u-lg subCate">กบ (2)</a>
				</div>
                <div class="col-sm-6 col-md-3">
					<a href="subCategory.php"  class="btn-u btn-brd btn-u-brown btn-u-lg subCate">ไก่ (2)</a>
				</div>
                <div class="col-sm-6 col-md-3">
					<a href="subCategory.php"  class="btn-u btn-brd btn-u-brown btn-u-lg subCate">หมู (2)</a>
				</div>
                <!--จบเมนูย่อย-->
			</div>
            <!--สินค้ามาใหม่-->
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-6 md-margin-bottom-40">
					<div class="easy-block-v2">
                        <a href="singleProduct.php" class="linkFull"></a>
						<div class="easy-bg-v2 rgba-default">มาใหม่</div>
						<img alt="" src="<?=base_url()?>mats/assets/img/upload/project/A003.jpg">
						<h3>กบ บ่อพลาสติก</h3>
						<ul class="list-unstyled">
							<li><span class="color-green">ประเภท:</span> สัตว์ / กบ</li>
							<li><span class="color-green">ราคา:</span> 140 บาท/กิโลกรัม</li>
                            <li><span class="color-green">ฟาร์ม:</span> สุจสำราญ</li>
				...
				<div class="col-md-3 col-sm-6">
					<div class="easy-block-v2">
                        <a href="singleProduct.php" class="linkFull"></a>
						<div class="easy-bg-v2 rgba-default">มาใหม่</div>
						<img alt="" src="<?=base_url()?>mats/assets/img/upload/project/A004.jpg">
						<h3>ไก่อินทรรย์</h3>
						<ul class="list-unstyled">
							<li><span class="color-green">ประเภท:</span> สัตว์ / ไก่</li>
							<li><span class="color-green">ราคา:</span> 60 บาท/กิโลกรัม</li>
                            <li><span class="color-green">ฟาร์ม:</span> เล้าลุงคำ</li>
        ...
        <!--สินค้ายอดนิยม-->
        <div class="parallax-team parallaxBg" style="background-position: 50% 33px;background: url(assets/img/animal-bg.jpg) 50% 0 repeat fixed !important;">
			<div class="container content">
				<div class="title-box-v2">
					<h2>สัตว์ <span class="color-green">อินทรีย์</span> ยอดนิยม</h2>
				</div>
                <div class="row">
				<!-- Begin Easy Block -->
				<div class="col-md-3 col-sm-6">
