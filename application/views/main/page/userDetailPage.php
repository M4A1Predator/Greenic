<div class="container content-md">
                    <form action="#" method="post" id="sky-form3" class="sky-form" novalidate="novalidate">
						...
						<fieldset>
                            <div class="row">
                                <section class="col-md-6 col-sm-6">
                                    ...
                                    <label class="input">
                                        <input type="text" name="projectName" id="projectName" value="สมปอง">
                                    </label>
                                </section>
                                <section class="col-md-6 col-sm-6">
                                    <label class="label"><strong>นาสกุล*</strong></label>
                                    <label class="input">
                                        <input type="text" name="projectName" id="projectName" value="มุ่งทำกิน">
                                    </label>
                                </section>
                            </div>
                            <div class="row">
                                <section class="col-md-6">
										...
										<label class="input">
                                        <input type="text" name="projectName" id="projectName" placeholder="บ้านเลขที่ หมู่ที่ ซอย" value="123 หมู่ 8 ซอยหลวงพ่อปากแดง">
                                    </label>
								</section>
				            ...
				            <div class="row">
                                ...
                                <section class="col-md-3">
                                    ...
                                    <label class="input">
                                        <input type="text" name="projectName" id="projectName" value="sompong@gmail.com">
                                    </label>
						...
						<footer>
							<a href="#"class="button">บันทึก <i class="fa fa-floppy-o" aria-hidden="true"></i></a>
						</footer>
