                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <section>
                                                                <label class="input">
                                                                    <input type="text" name="subCategoryName" id="subCategoryName" placeholder="กรอกขื่อประเภท">
                                                                </label>
                                                            </section>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <label class="input">
                                                                <label class="input">
                                                                    <input type="text" name="farmName" id="farmName" placeholder="ชื่อฟาร์ม">
                                                                </label>
                                                            </label>
                                                        ...
                                                        <label class="input">
                                                                <label class="input">
                                                                    <input type="text" name="homeNum" id="homeNum" placeholder="บ้านเลขที่ หมู่ที่">
                                                                </label>
                                                            </label>
                                                        </div>
                                                    </div>
