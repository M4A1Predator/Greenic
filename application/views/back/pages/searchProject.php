<article class="content items-list-page" >
                    ...
                    <div class="row" style="margin-bottom: 20px;">
                        <div class="col-sm-3">
                             <select class="form-control district" onchange='test("1")' id="filter1">
                        ...
                        <div class="col-sm-3">
                             <select class="form-control district" id="filter2">
                        ...
                        <ul class="pagination">
                          <?php for($i=1;$i<=$page_amount;$i++){ ?>
                            ...
                            <li class="page-item <?=$active_class?>">
                                <a class="page-link" href="<?=base_url().'gnc_admin/search?pageNum='.$i.'&keyword='.$key?>"><?=$i?></a
