<div class="cd-user-modal"> <!-- this is the entire modal form, including the background -->
			<div class="cd-user-modal-container"> <!-- this is the container wrapper -->
				<ul class="cd-switcher">
					<li><a href="<?=base_url()?>mats/javascript:void(0);">เข้าสู่ระบบ</a></li>
					<li><a href="<?=base_url()?>mats/javascript:void(0);">สมัครสมาชิก</a></li>
				</ul>

				<div id="cd-login"> <!-- log in form -->
					<form class="cd-form">
						<p class="social-login">
							<span class="social-login-facebook text-center"><a href="<?=base_url()?>mats/#"><i class="fa fa-facebook"></i>เข้าสู่ระบบด้วย Facebook</a></span>
						</p>
						...
						<p class="fieldset">
							...
							<a href="<?=base_url()?>mats/javascript:void(0);" class="hide-password">Hide</a>
					...
					<p class="cd-form-bottom-message"><a href="<?=base_url()?>mats/javascript:void(0);">ลืมรหัสผ่าน</a></p>
					<!-- <a href="<?=base_url()?>mats/javascript:void(0);" class="cd-close-form">Close</a> -->
				</div> <!-- cd-login -->

				<div id="cd-signup"> <!-- sign up form -->
					<form class="cd-form">
						<p class="social-login">
							<span class="social-login-facebook text-center"><a href="<?=base_url()?>mats/#"><i class="fa fa-facebook"></i>สมัครสมาชิกด้วย Facebook</a></span>
						...
						<p class="fieldset">
							...
							<input class="full-width has-padding has-border" id="signup-username" type="text" placeholder="ชื่อ-นามสกุล">
							<span class="cd-error-message">กรุณากรอกชื่อผู้ใช้งานให้ถูกต้อง!</span>
						</p>
						...
						<p class="fieldset">
							...
							<span class="cd-error-message">กรุณากรอกอีเมล์ให้ถูกต้อง!</span>
						</p>
						...
						<p class="fieldset">
							...
							<label for="accept-terms">ฉันยอมรับข้อตกลง <a href="<?=base_url()?>mats/javascript:void(0);"> อ่านข้อตกลง</a></label>
						</p>

						<p class="fieldset">
							<input class="full-width has-padding" type="submit" value="สมัครสมาชิก">
						</p>
					</form>
				...
				<div id="cd-reset-password"> <!-- reset password form -->
					...
					<p class="cd-form-bottom-message"><a href="<?=base_url()?>mats/javascript:void(0);">กลับไปหน้าเข้าสู่ระบบ</a></p>
