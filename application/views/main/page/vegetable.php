        <div class="breadcrumbs">
			<div class="container">
				<h1 class="pull-left">ผักอินทรีย์</h1>
				<ul class="pull-right breadcrumb">
					<li><a href="index.php">หน้าแรก</a></li>
					<li class="active">ผักอินทรีย์</li>
				</ul>
			</div>
		</div>
        <div class="container content-md">
            ...
            <div class="headline-center margin-bottom-20">
					<h2>ผัก <span class="color-green">อินทรีย์</span> มาใหม่</h2>
				</div>
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-6 md-margin-bottom-40">
					<div class="easy-block-v2">
						...
						<img alt="" src="<?=base_url()?>mats/assets/img/upload/project/0001.jpg">
            ...
            <div class="row">
				...
				<div class="col-md-3 col-sm-6">
					<div class="easy-block-v2">
						...
						<h3>ผักสลัดกรอบ</h3>
						<ul class="list-unstyled">
							<li><span class="color-green">ประเภท:</span> ผัก / ผักสลัด</li>
